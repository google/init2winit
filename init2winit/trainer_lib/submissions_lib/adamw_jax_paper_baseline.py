...
def map_i2w_hparams_to_algoperf_hparams(merged_hps):
  submission_hps = merged_hps
  submission_hps.unlock()

  submission_hps.learning_rate = merged_hps.lr_hparams.base_lr
  submission_hps.warmup_factor = merged_hps.lr_hparams.warmup_steps_fraction
  submission_hps.weight_decay = merged_hps.opt_hparams.weight_decay
  submission_hps.one_minus_beta1 = 1.0 - merged_hps.opt_hparams.beta1
  submission_hps.beta2 = merged_hps.opt_hparams.beta2

  submission_hps.lock()
  return submission_hps
...
def init_optimizer_state(workload: spec.Workload,
  ...
  return optimizer_state, opt_init_fn, opt_update_fn
...
def data_selection(workload: spec.Workload,
  ...
  Returns:
    A batch of training examples and labels.
  """
  del workload
  del optimizer_state
