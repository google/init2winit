...
def tag_attention_logits(logits):
  this_module = nn.module._context.module_stack[-1]  # pylint: disable=protected-access
  this_module.sow('attn_max_logit', 'attn_max_logit', logits.max())
  this_module.sow('attn_weights', 'attn_weights', logits)
...
def dot_product_attention_weights(query: Array,
  ...
  tag_attention_logits(attn_weights)
