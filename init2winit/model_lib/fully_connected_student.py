...
DEFAULT_HPARAMS = config_dict.ConfigDict(
    dict(
        ...
        model_dtype='float32',
        grad_clip=None,
        teacher_model_name=None,  # no distillation by default
    ))


class FullyConnectedStudent(nn.Module):
...
class FullyConnectedStudentModel(base_model.BaseModel):
  """Defines a fully connected student model."""
