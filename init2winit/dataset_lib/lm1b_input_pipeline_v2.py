...
"""Input pipeline for a LM1B dataset based on TFDS API.

forked from
https://github.com/google/flax/blob/b60f7f45b90f8fc42a88b1639c9cc88a40b298d3/examples/lm1b/input_pipeline.py
"""
...
def get_lm1b_datasets(hps, per_host_batch_size, per_host_eval_batch_size,
  ...
  train_ds_builder = tfds.builder('lm1b')
